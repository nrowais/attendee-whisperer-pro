...
export const Route = createFileRoute("/_authenticated/fleet")({
  head: () => ({
    meta: [
      { title: "السائقون والمركبات — حوار الأمن والتاريخ" },
      {
        name: "description",
        content: "إدارة السائقين والمركبات وربطها برحلات الوصول والمغادرة لكل متحدث.",
      },
      { property: "og:title", content: "السائقون والمركبات — حوار الأمن والتاريخ" },
      {
        property: "og:description",
        content: "إدارة أسطول النقل وتوزيع السائقين على رحلات الوصول والمغادرة.",
      },
